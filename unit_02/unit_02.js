...
const f1 = () => {
    ...
    const result = a1.includes(val)
    return out.innerHTML = result.toString()
...
const f2 = () => {
    ...
    if (a2.includes(val)) {
        return out.innerHTML = a1.indexOf(val).toString()
    } else {
...
const f3 = () => {
    ...
    return a3.flat().includes(val) ? out.innerHTML = "true" : out.innerHTML = "false"
}
